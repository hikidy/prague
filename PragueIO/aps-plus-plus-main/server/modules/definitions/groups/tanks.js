    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.single, g.rangeless, g.speedless, g.recoilless, g.doublereload, g.doublereload, g.doublereload, g.doublereload, g.bigger]),
                TYPE: "collision",
                AUTOFIRE: true,
            },
        },
...
exports.lancer = {
    ...
    GUNS: [
        {
            POSITION: [30, 15, 0.01, 0, 0, 0, 0],
        },
        {
            POSITION: [5, 0.005, 1, 0, 0, 0, 0],
            PROPERTIES: {
...
// TANK UPGRADE PATHS
exports.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "uzi", "lancer", "heatseeker", "angleTri"/* "whirlwind"*/];
    ...
    exports.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper", "backShield"];
    ...
    exports.trapper.UPGRADES_TIER_2 = ["builder", "triTrapper", "trapGuard", "manufacturer"];
    ...
    exports.uzi.UPGRADES_TIER_2 = ["minigun", "magazine"];
        exports.magazine.UPGRADES_TIER_3 = ["plower"];

    exports.angleTri.UPGRADES_TIER_2 = ["triAngle", "accelerator", "pedaler", "steamboat"];
        exports.accelerator.UPGRADES_TIER_3 = ["booster", "velocity"];
