module.exports = {
    ...
    twin: { recoil: 0.5, shudder: 0.9, health: 0.9, damage: 0.99, spray: 1.2 },
    double: { damage: 0.9 },
    ...
    halfthruster: { recoil: 1.25, shudder: 2, health: 0.8, damage: 0.55, pen: 0.7, spray: 0.4, resist: 0.1 },
    ...
    // Uzis
    uzi: { reload: 1.9, recoil: 0.6, size: 0.8, damage: 0.75, speed: 1.55 },
    ...
    speedless: { speed: 0.0001, maxSpeed: 0.7 },

    // Misc 2
    healer: { damage: -1 },
    lancer: { damage: 1.2, reload: 0.4, speed: 0.1, maxSpeed: 0.1, range: 0.077, recoil: 0.00000000000000000000000000000000000000000001 },
    celeslower: { size: 0.5 },
